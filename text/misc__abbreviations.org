...
#+LATEX_HEADER: description={Cost function used for neral networks with classification into multiple classes.},
#+LATEX_HEADER: }

#+LATEX_HEADER: \newglossaryentry{dropout}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={dropout},
#+LATEX_HEADER: description={Regularization technique that is randomly disabling some connections in network during traing phase.},
#+LATEX_HEADER: }
