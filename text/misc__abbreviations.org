...
#+LATEX_HEADER: \newglossaryentry{ensemble model}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={ensemble model},
...
#+LATEX_HEADER: description={Machine learning task that tries to assign correct class to a data instance},
#+LATEX_HEADER: }
...
#+LATEX_HEADER: description={Linear model},
#+LATEX_HEADER: }

#+LATEX_HEADER: \newglossaryentry{af}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={activation function},
#+LATEX_HEADER: description={Function that usually performes non-linear transformation of inputs},
#+LATEX_HEADER: }

#+LATEX_HEADER: \newglossaryentry{hidden layer}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={hidden layer},
#+LATEX_HEADER: description={Referring to a layer that is neither input nor output, but merely somewhere between},
#+LATEX_HEADER: }

#+LATEX_HEADER: \newglossaryentry{cost function}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={cost function},
#+LATEX_HEADER: description={Equivalent to loss function},
#+LATEX_HEADER: }

#+LATEX_HEADER: \newglossaryentry{loss function}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={loss function},
#+LATEX_HEADER: description={Function that is used to estimate error of a model on given data},
#+LATEX_HEADER: }

#+LATEX_HEADER: \newglossaryentry{fc}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={fully connected},
#+LATEX_HEADER: description={Outputs of each neuron in $l$ layer are connected into inputs of all neurons in $l+1$ layer},
#+LATEX_HEADER: }

#+LATEX_HEADER: \newglossaryentry{max-pooling}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={Max-Pooling},
#+LATEX_HEADER: description={Method of input size reduction in convolutional neural networks},
#+LATEX_HEADER: }

#+LATEX_HEADER: \newglossaryentry{gradient descent}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={gradient descent},
#+LATEX_HEADER: description={Learning algorithm based on following path of steepest negative change in gradient},
#+LATEX_HEADER: }

#+LATEX_HEADER: \newglossaryentry{sum of square}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={sum of square},
#+LATEX_HEADER: description={Loss function},
#+LATEX_HEADER: }

#+LATEX_HEADER: \newglossaryentry{feature map}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={feature map},
#+LATEX_HEADER: description={Output of convolution operation over input},
#+LATEX_HEADER: }

#+LATEX_HEADER: \newglossaryentry{zero padding}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={zero padding},
#+LATEX_HEADER: description={Expansion of input data by adding elements of zero value around the edges},
#+LATEX_HEADER: }

#+LATEX_HEADER: \newglossaryentry{locally connected}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={locally connected},
#+LATEX_HEADER: description={Convolution layer that has kernel of the same size as input},
#+LATEX_HEADER: }

#+LATEX_HEADER: \newglossaryentry{detector stage}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={detector stage},
#+LATEX_HEADER: description={Application of activation function},
#+LATEX_HEADER: }

#+LATEX_HEADER: \newglossaryentry{tiled convolution}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={tiled convolution},
#+LATEX_HEADER: description={Convolution layer with differing coverage in neighboring pixels},
#+LATEX_HEADER: }
...
#+LATEX_HEADER: description={Activation function historically used in Perceptron model},
#+LATEX_HEADER: }
...
#+LATEX_HEADER: description={Activation function commonly used in recurrent neural networks},
#+LATEX_HEADER: }
...
#+LATEX_HEADER: \newglossaryentry{categorical cross entropy}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={categorical cross entropy},
#+LATEX_HEADER: description={Cost function used for neural networks with classification into multiple classes},
#+LATEX_HEADER: }

#+LATEX_HEADER: \newglossaryentry{dropout}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={dropout},
#+LATEX_HEADER: description={Regularization technique that is randomly disabling some connections in network during training phase},
#+LATEX_HEADER: }

#+LATEX_HEADER: \newglossaryentry{adam}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={adam},
#+LATEX_HEADER: description={Learning algorithm based on gradient descent \cite{article--dozat--2015}},
#+LATEX_HEADER: }

#+LATEX_HEADER: \newglossaryentry{nadam}
#+LATEX_HEADER: {
#+LATEX_HEADER: name={nadam},
#+LATEX_HEADER: description={Learning algorithm based on gradient descent \cite{article--dozat--2015}},
#+LATEX_HEADER: }
