...
** TODO Image Processing
   ...
   Computer vision is important subject in image processing. Research in the subject was for many years approaching the problem from bottom up perspective. This was the already mentioned effort to formalize rules that are guiding the vision of living organisms. This approach was actually very successful in certain circumstances.
